...
if(isset($_POST['search']))
{
    ...
    $query = "select * from cloth_avail WHERE CONCAT(ClothType,ClothName,Size,AvailableAmount,NgoName,NgoLocation) LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
else 
{
    $query = "select * from cloth_avail";
    $search_result = filterTable($query);
}
...
<head>
  ...
  <body>
    <h2>Have a look at Available Clothes!!!</h2>
...
!-->
        <form action="availableclothdetails.php" method="post">
    <center>
          <div class="no-print">
   ...
   <table width="100%" border="2" class="table table-striped ">
      ...
      <tbody>
                   ...
                   <tr>
                              ...
                              <td><?php echo $ClothType=$row['ClothType']; ?></td>
                              <td><?php echo $ClothName=$row['ClothName']; ?></td>
