...
if(isset($_POST['search']))
{
    ...
    $query = "select * from medicine WHERE CONCAT(Name,Phone,Email,Address,MedicineName,Quantity,DonationDate,ExpiryDate) LIKE '%".$valueToSearch."%'";
...
!-->
        <form action="medicinedetails.php" method="post">
    <center>
          <div class="no-print">
