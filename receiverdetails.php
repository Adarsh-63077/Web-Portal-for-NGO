...
if(isset($_POST['search']))
{
    ...
    $query = "select * from receiver WHERE CONCAT(Name,Phone,Address,Goods,Quantity,NgoName,Date) LIKE '%".$valueToSearch."%'";
...
<head>
  ...
  <body>
    <h2>Have a look at other Receivers!!!</h2>
...
!-->
        <form action="receiverdetails.php" method="post">
    <center>
          <div class="no-print">
