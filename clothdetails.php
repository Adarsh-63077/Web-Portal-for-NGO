...
if(isset($_POST['search']))
{
    ...
    $query = "select * from doner WHERE CONCAT(DonerName,PhoneNumber,Email,Address,Cloth,Quantity,BuyDate,DonationDate) LIKE '%".$valueToSearch."%'";
...
!-->
        <form action="clothdetails.php" method="post">
    <center>
          <div class="no-print">
  ...
  <br><br>
   ...
   <table width="100%" border="2" class="table table-striped ">
      ...
      <tbody>
                   ...
                   <tr>
                              <td height="28"><?php echo $DonerName=$row['DonerName']; ?></td>
                              <td><?php echo $PhoneNumber=$row['PhoneNumber']; ?></td>
                              <td><?php echo $Email=$row['Email']; ?></td>
                              <td><?php echo $Address=$row['Address']; ?></td>
                              <td><?php echo $Cloth=$row['Cloth']; ?></td>
                              <td><?php echo $Quantity=$row['Quantity']; ?></td>
                              <td><?php echo $BuyDate=$row['BuyDate']; ?></td>
