...
if(isset($_POST['search']))
{
    ...
    $query = "select * from medi_avail WHERE CONCAT(MedicineName,AvailableAmount,ExpiryDate,NgoName,NgoLocation) LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
else 
{
    $query = "select * from medi_avail";
    $search_result = filterTable($query);
}
...
<head>
  ...
  <body>
    <h2>Have a look at Available Medicines!!!</h2>
...
!-->
        <form action="availablemedidetails.php" method="post">
    <center>
          <div class="no-print">
   ...
   <table width="100%" border="2" class="table table-striped ">
      ...
      <tbody>
                   ...
                   <tr>
                              ...
                              <td><?php echo $MedicineName=$row['MedicineName']; ?></td>
                              <td><?php echo $AvailableAmount=$row['AvailableAmount']; ?></td>
                              <td><?php echo $ExpiryDate=$row['ExpiryDate']; ?></td>
